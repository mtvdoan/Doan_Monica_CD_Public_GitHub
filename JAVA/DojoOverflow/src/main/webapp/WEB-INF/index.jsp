...
<head>
 ...
 <body>
    <h1>Welcome</h1>
    <a href="/dashboard" type="button" class="btn btn-primary">Go to Questions Dashboard</a>
    <a href="/questions/new" type="button" class="btn btn-info">+ New Question to Dashboard</a>
</body>
