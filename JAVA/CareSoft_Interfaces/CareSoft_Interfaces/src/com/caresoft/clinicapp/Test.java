...
public class Test {
	...
	public static void main(String[] args) {
        ...
        //*Physician's pin must be EXACTLY 4 to be accepted.
        //*doctor10's pin is 42 and that's an invalid
        //*We EXPECTED it to return 'false', so we say pass when it's false.
        ...
        System.out.println("\n========== AdminUser Tests ==========\n");
        //*In this test we have ADMIN USER Rose Tyler's pin as 42. 
        //*Admin Users pin MUST BE 6 DIGITS or more
        //Her pin 'Fails" as expected. So the test 'PASSES'
